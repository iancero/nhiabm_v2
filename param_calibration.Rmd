...
- Overall suicide attempt rates
    ...
    - IND will yield fewer suicide attempts and lower average risk rate than the NHI while, the it (IND) is active
    - NHI will yield fewer suicide attempts and lower average risk rate in the simulation year following the intervention conclusion, compared to both IND and CTRL
    - Both interventions will be practically equivalent (e.g., within 10%) to the CTRL's attempt rate by the final 100 ticks

- Moderators
    - Individual Level: Baseline isolate status will moderate an NHI effect, such that the effects of the NHI will be greater. Including:
        - Greater new ties will be directed toward baseline isolates
        - Greater risk reduction
    - Group Level: Networks with greater dysfunction will experience greater benefit from an NHI
        
Exploratory
    - How much benefit does the NHI receive from preferential rewiring toward isolates? We predict more targeting means more suicide reduction
    - What kind of benefit will be produced for non-enrolled people?
